      ...
      <article className="flex flex-col items-center w-full  md:mt-8">
         <section className="w-full grid grid-cols-2  h-[calc(100vh-104px)] ">
            <div className=" flex items-center flex-col justify-center font-dm_sans gap-2 px-16">
               <h1 className="text-6xl w-full text-justify">
                  Hello, I am <span className="text-blue-600">Simón</span>
               </h1>
               <p className="w-full text-justify pl-1">
                  <span className="text-blue-600">Systems engineer</span>{" "}
                  specialized in web development. This is my portfolio built
                  with Next.js, where you can explore the projects I have worked
         ...
         <section className="w-full flex flex-col items-center min-h-screen pt-[104px]">
            <h2 className="text-blue-600 uppercase text-2xl">
               Mis habilidades
            </h2>
